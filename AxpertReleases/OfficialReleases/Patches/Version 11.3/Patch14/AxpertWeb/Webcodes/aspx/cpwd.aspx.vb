...
Partial Class cpwd
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If (Request.QueryString("remark") <> Nothing) Then
            ...
            End If
            If (Session("project") IsNot Nothing And Session("nsessionid") IsNot Nothing) Then
                util.RemoveLoggedUserDetails(Session("project").ToString(), Session("nsessionid").ToString())
            End If
        End If
