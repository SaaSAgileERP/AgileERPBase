...
<head runat="server">
    ...
    <script type="text/javascript" src="../Js/tstruct.min.js?v=615"></script>
    <script type="text/javascript" src="../Js/helper.min.js?v=168"></script>
    <script type="text/javascript" src="../Js/jsclient.min.js?v=115"></script>
...
<body onload="ChangeDir('<%=direction%>');">
    <form id="form1" runat="server">
        <asp:ScriptManager ID="ScriptManager1" runat="server">
            <Scripts>
                <asp:ScriptReference Path="../Js/tstruct.min.js?v=615" />
            </Scripts>
            <Services>
